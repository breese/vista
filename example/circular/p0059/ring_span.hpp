#ifndef VISTA_CIRCULAR_EXAMPLE_P0056_RING_SPAN_HPP
#define VISTA_CIRCULAR_EXAMPLE_P0056_RING_SPAN_HPP
...
public:
    ...
    void swap(type& other) noexcept(vista::detail::is_nothrow_swappable<Popper>::value)
    {
        using std::swap;
...
#endif // VISTA_CIRCULAR_EXAMPLE_P0056_RING_SPAN_HPP
